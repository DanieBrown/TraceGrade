...
export function toExamTemplateListItem(raw: unknown): ExamTemplateListItem | null {
  ...
  return {
    ...
    assignmentId,
    title,
    subject: toOptionalTrimmedString(rawTemplate.subject),
    topic: toOptionalTrimmedString(rawTemplate.topic),
    description: toOptionalTrimmedString(rawTemplate.description),
    gradeLevel: toOptionalTrimmedString(rawTemplate.gradeLevel),
    difficultyLevel: toOptionalTrimmedString(rawTemplate.difficultyLevel),
    questionCount,
    totalPoints,
    statusLabel,
